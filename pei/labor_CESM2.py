...
wbt = xr.open_dataset('../data/processed/CESM2/WBTdailymean/WBT1281ens009.nc',chunks={'time':1095})
...
t_ref = xr.open_dataset('../data/processed/CESM2/TSAdailymean/TSA1281ens009.nc',chunks={'time':1095})
...
# Save as data file
cap_monthly.to_netcdf('../data/processed/CESM2/Monthly_Capacity/monthly_capacity_1281_ens9_1980-2100.nc')